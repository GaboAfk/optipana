...
export function ContactLensIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" {...props}>
      <circle cx="8.5" cy="15" r="6.5" />
      <circle cx="8.5" cy="15" r="2.5" />
      <path d="M18 3a3.5 3.5 0 0 1 0 7M21 5a3.5 3.5 0 0 0-3.5 3.5" />
    </svg>
  );
}
...
export function CaseIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" {...props}>
      ...
      <path d="M9 10v1M15 10v1M2 12h20" />
    </svg>
  );
}
...
export function SparkleIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" {...props}>
      <path d="M12 2c.6 3.8 2.2 6.4 6 7-3.8.6-5.4 3.2-6 7-.6-3.8-2.2-6.4-6-7 3.8-.6 5.4-3.2 6-7zM19 13c.35 2.2 1.28 3.65 3.5 4-2.22.35-3.15 1.8-3.5 4-.35-2.2-1.28-3.65-3.5-4 2.22-.35 3.15-1.8 3.5-4zM5 15c.3 1.9 1.1 3.1 3 3.4-1.9.3-2.7 1.5-3 3.4-.3-1.9-1.1-3.1-3-3.4 1.9-.3 2.7-1.5 3-3.4z" />
    </svg>
  );
}
