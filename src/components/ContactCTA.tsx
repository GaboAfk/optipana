...
export function ContactCTA() {
  return (
    ...
    <section id="contacto" className="relative overflow-hidden bg-gradient-to-r from-brand-orange via-[#C2491F] to-brand-purple py-20 md:py-28">
      ...
      {/* El outer div es el observado por whileInView y NO se transforma:
          si el transform viviera en el mismo elemento, al animar y:40→0 cerca
          del borde superior el ratio visible caería bajo `amount` y re-dispararía
          la salida, oscilando en bucle. */}
      <motion.div
        initial="hidden"
        whileInView="show"
