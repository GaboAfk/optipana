...
export const products: Product[] = [
  makeProduct(1, "/glasses_catalog/selfies/209675188-1-tort.avif", "/glasses_catalog/209675188-2.jpg", "Mariposa Carey", "recetados", "damas", "tortoise", "orange"),
  makeProduct(2, "/glasses_catalog/selfies/209680312-1-brown.avif", "/glasses_catalog/209680312-1.jpg", "Rectangular Café", "recetados", "unisex", "brown", "purple"),
  makeProduct(4, "/glasses_catalog/selfies/209833250-2-brown.avif", "/glasses_catalog/209833250-1-brown.jpg", "Clásico Ámbar", "recetados", "damas", "brown", "purple"),
  makeProduct(5, "/glasses_catalog/selfies/209833279-2-clear.avif", "/glasses_catalog/209833279-1-clear.jpg", "Aviador Cristal", "recetados", "damas", "clear", "orange"),
  ...
  makeProduct(8, "/glasses_catalog/selfies/209833317-2-orange.avif", "/glasses_catalog/209833317-1-orange.jpg", "Oversize Naranja", "sol", "damas", "orange", "purple"),
  makeProduct(9, "/glasses_catalog/209833338-1-green.jpg", undefined, "Esmeralda Bold", "recetados", "damas", "green", "orange"),
  makeProduct(10, "/glasses_catalog/selfies/209833378-2-brown.avif", "/glasses_catalog/209833378-1-brown.jpg", "Cuadrado Ámbar", "recetados", "damas", "brown", "purple"),
  makeProduct(11, "/glasses_catalog/209833408-1-multi.jpg", undefined, "Mosaico Carmesí", "recetados", "damas", "multicolor", "orange"),
  makeProduct(12, "/glasses_catalog/selfies/209994771-2-torte.avif", "/glasses_catalog/209994771-1-torte.jpg", "Milano Carey", "recetados", "damas", "tortoise", "purple"),
  makeProduct(13, "/glasses_catalog/selfies/210121474-2-brown.avif", "/glasses_catalog/210121474-1-brown.jpg", "Clubmaster Café", "recetados", "caballeros", "brown", "orange"),
  ...
  makeProduct(15, "/glasses_catalog/selfies/210723065-2-black.avif", "/glasses_catalog/210723065-1-black.jpg", "Rectangular Ónix", "recetados", "caballeros", "black", "orange"),
  ...
  makeProduct(18, "/glasses_catalog/selfies/211027814-2-black.avif", "/glasses_catalog/211027814-1-black.jpg", "Shield Deportivo Negro", "sol", "damas", "black", "purple"),
  ...
  makeProduct(21, "/glasses_catalog/selfies/211554151-2-burgundy.avif", "/glasses_catalog/211554151-1-burgundy.jpg", "Aviador Borgoña", "recetados", "caballeros", "burgundy", "orange"),
  ...
  },
  {
    ...
    brand: "OptiPana",
    price: 25,
    img: "/glasses_catalog/contacto.avif",
    variant: "contacts",
    frame: "transparent",
    lens: "clear",
    blob: "orange",
  ...
  },
  {
    ...
    brand: "OptiPana",
    price: 30,
    img: "/glasses_catalog/contacto-2.avif",
    variant: "contacts",
    frame: "transparent",
    lens: "clear",
    blob: "purple",
  ...
  },
  {
    ...
    brand: "Symphorine",
    price: 8,
    img: "/glasses_catalog/correa-canutillo-multicolor.avif",
    variant: "case",
    frame: "multicolor",
    lens: "clear",
    blob: "orange",
  ...
  },
  {
    ...
    brand: "Óptica Carrau",
    price: 15,
    img: "/glasses_catalog/cadena-eslabon-chico.avif",
    variant: "case",
    frame: "gold",
    lens: "clear",
    blob: "purple",
  ...
  },
  {
    ...
    brand: "Mis Petates",
    price: 25,
    img: "/glasses_catalog/estuche-verde-petroleo.avif",
    variant: "case",
    frame: "petrol green",
    lens: "clear",
    blob: "orange",
